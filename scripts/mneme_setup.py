...
def _common_yaml(instance_dir, db_path, port, inject, ctx_tokens, memory_only, mcp_servers=None):
...
def write_config(backend, models, port, inject, memory_only, instance_dir, db_path, mcp_servers=None):
    ...
    if backend == "openrouter":
        ...
        btype, bprov = "ollama", ""
    yaml = _common_yaml(instance_dir, db_path, port, inject_s, models.get("ctx_size", 64000), mo_s, mcp_servers)
...
def main():
    ...
    cfg_path = write_config(backend, models, port, inject, memory_only, instance_dir, db_path, mcp_servers)
