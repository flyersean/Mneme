...
# ── Config + start script ───────────────────────────────────────
def _common_yaml(memory_dir, port, inject, ctx_tokens, memory_only):
...
def write_config(backend, models, port, inject, memory_only):
    ...
    if backend == "openrouter":
        ...
        btype, bprov = "ollama", ""
    yaml = _common_yaml(MEMORY_DIR, port, inject_s, models.get("ctx_size", 256000), mo_s)
