...
""")
    ...
    env = os.environ.copy()
    env.update({
        "MNEME_MODEL": proxy_model, "MNEME_PORT": str(port),
...
def main():
    ...
    # Cleanup from previous runs — but NOT when adding a second instance: the
    # existing proxy + Ollama must stay up (and _add_model needs Ollama running
