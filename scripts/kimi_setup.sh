...
#   curl -sSL https://raw.githubusercontent.com/flyersean/Mneme/novelty-thinking/scripts/kimi_setup.sh | bash
set -e
...
if [ -t 0 ]; then
    ...
    # No terminal (SSH, Docker) — run without redirect, wizard handles EOF
