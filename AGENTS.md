...
| `caps` | `max_history_messages` 32, `db_msg_cap` 8000, `compress_threshold` 500, `compress_max_tok` 2048, `max_tool_forward` 12000, `tool_followup_budget` 30000, `chunk_size` 4000 |
