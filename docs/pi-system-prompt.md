# Pi Agent — System Prompt Reference
# Extracted from Pi v0.84.x source
# This is what Pi sends as the system message BEFORE Mneme adds its prompt.
# Mneme prepends "=== MNEME INSTRUCTIONS ===" + system_prompt.md BEFORE this.
